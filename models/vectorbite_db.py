...
db.define_table('task',
                ...
                Field('dataset_citation', type='string', comment='Digital Object Identifier for the dataset'),
                ...
                Field('file', 'upload', required=IS_EMPTY_OR(IS_LENGTH(200000), IS_UPLOAD_FILENAME(extension='csv')), comment='* File has to be in .csv format, max size 200mb'),
