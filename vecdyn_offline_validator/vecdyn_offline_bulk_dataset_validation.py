...
with open('/home/matt/Desktop/data/vecdyn_vectorbase_range_a_bulk_upload_dataset_9.csv' , 'r') as csvfile:
    ...
    validator.add_value_check('title', datatype_required(str),
                              'title error', 'entry must be string and =< 250 characters')
    validator.add_value_check('dataset_citation', datatype_not_required(str),
                              'dataset_citation error', 'entry must be string and =< 250 characters')
    validator.add_value_check('publication_citation', datatype_not_required(str),
                              'publication_citation error', 'entry must be string and =< 250 characters')
    validator.add_value_check('description', text_required(str),
                              'description error', 'entry must be string and =< 32768 characters')
    validator.add_value_check('url', datatype_not_required(str),
                              'url error', 'entry must be string and =< 250 characters')
    validator.add_value_check('contact_name', text_not_required(str),
                              'contact_name error', 'entry must be a string and =< 32768 characters')
    validator.add_value_check('contact_affiliation', datatype_not_required(str),
                              'contact_affiliation error', 'entry must be string and =< 250 characters')
    validator.add_value_check('email', datatype_not_required(str),
                              'email error', 'entry must be string and =< 250 characters')
    validator.add_value_check('orcid', datatype_not_required(str),
                              'orcid code error', 'entry must be string and =< 250 characters')
    validator.add_value_check('dataset_license', datatype_required(str),
                              'dataset_license error', 'entry must be string and =< 250 characters')
    ...
    validator.add_value_check('publication_status', datatype_not_required(str),
                              'publication_status error', 'entry must be string and =< 250 characters')
    validator.add_value_check('taxon', datatype_required(str),
                              'taxon error', 'entry must be string and =< 250 characters')
    validator.add_value_check('location_description', datatype_required(str),
                              'location_description error', 'entry must be string and =< 250 characters')
