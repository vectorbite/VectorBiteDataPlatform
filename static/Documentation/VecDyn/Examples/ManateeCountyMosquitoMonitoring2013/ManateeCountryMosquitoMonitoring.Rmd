...
###Import the Manatee County Mosquito Data Sets (2012-2016) from URL, when importing datasets, make sure you set 'stringsAsFactors=FALSE' to ensure R doesnt apply any formatting to the dataframe. 
...
```
###Bind all the datasets together using 
```{r}
...
###Check the dataframe to see if it all worked and reveal column names
